...
(function ExportLibrary(root, factory) {
  ...
  var PahoMQTT = (function (wx) {
      ...
      var doPing = function () {
        if (!this.isReset) {
          ...
          wx.sendSocketMessage({
            ...
            fail: function () {
              // 
              console.log('wx.sendSocketMessage fail');
            },
            complete: function () {
              // 
            }
     ...
     */
    var ClientImpl = function (uri, host, clientId) {
      this._trace("Paho.MQTT.Client", uri, host, clientId);
    ...
    ClientImpl.prototype._doConnect = function (wsurl) {
      ...
      var wsurl = 'wss://broker.hyecosmart.com/mqtt';
      wx.connectSocket({
        url: wsurl,
        header: {
     ...
     */
    var Client = function (host,clientId) {
      ...
      if (arguments.length == 2) {
        ...
        uri = "ws://" + (ipv6AddSBracket ? "[" + host + "]" : host);
      }

      var clientIdLength = 0;
      clientId ='8d08aae1-bb5d-46c8-9371-f188cb47e275';
      ...
      var client = new ClientImpl(uri, host, clientId);
